...
{
 VAL_ITS_GET, PSA_ERROR_INVALID_ARGUMENT /* Call get API with NULL write buffer and 0 length */
},
{
...
{
 VAL_ITS_GET, PSA_ERROR_INVALID_ARGUMENT /* Call get API with 0 length and NULL read buffer */
},
{
